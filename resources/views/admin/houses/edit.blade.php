                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                @foreach ($house->images as $image)
                                    <label class="relative rounded-box overflow-hidden aspect-[4/3] cursor-pointer group block">
                                        <img
                                        ...
                                        <div class="absolute inset-0 bg-neutral/0 group-has-[:checked]:bg-error/60 transition-colors flex items-start justify-end p-2">
                                            <input
                                                type="checkbox"
                                                name="remove_images[]"
                                                value="{{ $image->id }}"
                                                class="checkbox checkbox-sm checkbox-error bg-base-100"
                                            />
                                        </div>
                                    </label>
                                @endforeach
