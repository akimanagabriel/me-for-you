        ...
        <div class="container mx-auto px-4">
            <nav class="text-sm text-[#7a7268]">
                <ol class="flex items-center space-x-2">
                    ...
                    <li><a href="{{ route('services.housing') }}" class="hover:text-[#b87f3a] transition-colors">Housing</a>
                    </li>
                    <li><i class="fas fa-chevron-right text-xs text-[#7a7268]/40"></i></li>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div class="lg:col-span-2">
                    ...
                    <!-- Title & Basic Info -->
                    <div class="mb-6">
                        <h1 class="font-display text-3xl md:text-4xl font-semibold text-[#1a1714] mb-3">{{ $house->title }}
                        </h1>
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                                @foreach ($house->images as $image)
                                    <div class="rounded-lg overflow-hidden aspect-square bg-[#f5f0e8] hover:opacity-90 transition-opacity cursor-pointer"
                                        onclick="openLightbox('{{ $image->image_path }}', '{{ $image->alt_text ?? $house->title }}')">
                                        <img src="{{ $image->image_path }}" alt="{{ $image->alt_text ?? $house->title }}"
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-[#f5f0e8] rounded-xl p-6 border border-[#ede7d8]">
                        ...
                        <div class="flex items-center gap-4">
                            <div
                                class="w-14 h-14 bg-[#b87f3a]/10 rounded-full flex items-center justify-center text-[#b87f3a]">
                    ...
                    <div class="bg-[#f5f0e8] rounded-xl p-6 border border-[#ede7d8]">
                        <h3 class="font-display text-xl font-semibold text-[#1a1714] mb-4 flex items-center gap-2">
                            <i class="fa-solid fa-share-nodes text-[#b87f3a]"></i> Share This Property
                        </h3>
                        <div class="flex gap-3">
                            ...
                            <a href="https://wa.me/?text={{ urlencode($house->title . ' - ' . url()->current()) }}"
                                target="_blank"
                            ...
                            <a href="mailto:?subject={{ urlencode($house->title) }}&body={{ urlencode('Check out this property: ' . url()->current()) }}"
                        ...
                        @foreach ($relatedHouses as $related)
                            <div
                                ...
                                <div class="relative h-40 overflow-hidden">
                                    <img src="{{ $related->cover_image ?? asset('assets/housing/property-placeholder.jpg') }}"
                                        alt="{{ $related->title }}"
                                    ...
                                    @elseif($related->status === 'rented')
                                        <span
                                            class="absolute top-2 right-2 bg-red-500 text-white text-[10px] font-semibold px-2 py-0.5 rounded-full">Rented</span>
                                    @endif
                                </div>
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center justify-between mt-2">
                                        ...
                                        <a href="{{ route('services.house.show', $related->slug) }}"
