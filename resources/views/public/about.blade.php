        ...
        <div class="container mx-auto px-4 relative z-10">
            <div class="max-w-3xl">
                ...
                <p class="text-lg text-white/60 max-w-2xl leading-relaxed">
                    We Create Experiences. We Connect Solutions. We Deliver Excellence.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
                <div class="text-center">
                    <div class="w-16 h-16 bg-[#b87f3a]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-users text-[#b87f3a] text-2xl"></i>
                    </div>
                    <p class="font-display text-4xl font-semibold text-[#1a1714]">{{ number_format($stats['clients']) }}+
                    </p>
                    <p class="text-sm text-[#7a7268] mt-1">Happy Clients</p>
                </div>
                <div class="text-center">
                    <div class="w-16 h-16 bg-[#b87f3a]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-house text-[#b87f3a] text-2xl"></i>
                    </div>
                    <p class="font-display text-4xl font-semibold text-[#1a1714]">{{ number_format($stats['properties']) }}+
                    </p>
                    <p class="text-sm text-[#7a7268] mt-1">Properties Managed</p>
                </div>
                <div class="text-center">
                    <div class="w-16 h-16 bg-[#b87f3a]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-calendar-days text-[#b87f3a] text-2xl"></i>
                    </div>
                ...
                <div class="text-center">
                    <div class="w-16 h-16 bg-[#b87f3a]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-car text-[#b87f3a] text-2xl"></i>
                    </div>
                    <p class="font-display text-4xl font-semibold text-[#1a1714]">{{ number_format($stats['vehicles']) }}+
                    </p>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                <div class="text-center p-8 rounded-xl bg-[#f5f0e8] hover:shadow-lg transition-shadow duration-300">
                    <div class="w-16 h-16 bg-[#b87f3a]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-handshake text-[#b87f3a] text-2xl"></i>
                    </div>
                    <h3 class="font-display text-xl font-semibold text-[#1a1714] mb-3">Professionalism</h3>
                    <p class="text-[#7a7268] leading-relaxed">Expert service at every touchpoint, from first call to final
                        delivery.</p>
                </div>
                <div class="text-center p-8 rounded-xl bg-[#f5f0e8] hover:shadow-lg transition-shadow duration-300">
                    <div class="w-16 h-16 bg-[#b87f3a]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-coins text-[#b87f3a] text-2xl"></i>
                    </div>
                    <h3 class="font-display text-xl font-semibold text-[#1a1714] mb-3">Affordability</h3>
                    <p class="text-[#7a7268] leading-relaxed">Premium quality without premium prices value you can trust.
                    </p>
                </div>
                <div class="text-center p-8 rounded-xl bg-[#f5f0e8] hover:shadow-lg transition-shadow duration-300">
                    <div class="w-16 h-16 bg-[#b87f3a]/10 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-shield-halved text-[#b87f3a] text-2xl"></i>
                    </div>
                    <h3 class="font-display text-xl font-semibold text-[#1a1714] mb-3">Trustworthiness</h3>
                    <p class="text-[#7a7268] leading-relaxed">We show up, deliver, and stand behind everything we promise.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <a href="{{ route('services.housing') }}"
                    class="group bg-white rounded-xl p-8 shadow-sm hover:shadow-xl transition-all duration-300 border border-[#ede7d8] hover:border-[#b87f3a]">
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            class="w-12 h-12 bg-[#b87f3a]/10 rounded-full flex items-center justify-center group-hover:bg-[#b87f3a]/20 transition-colors">
                            <i class="fa-solid fa-house text-[#b87f3a] text-xl"></i>
                        </div>
                        <h3 class="font-display text-xl font-semibold text-[#1a1714]">Housing</h3>
                    </div>
                    <p class="text-[#7a7268] leading-relaxed">Find your perfect home or investment property with our expert
                        guidance.</p>
                ...
                <a href="{{ route('services.events') }}"
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            class="w-12 h-12 bg-[#b87f3a]/10 rounded-full flex items-center justify-center group-hover:bg-[#b87f3a]/20 transition-colors">
                            <i class="fa-solid fa-calendar-days text-[#b87f3a] text-xl"></i>
                        </div>
                        <h3 class="font-display text-xl font-semibold text-[#1a1714]">Events</h3>
                    </div>
                    <p class="text-[#7a7268] leading-relaxed">Create unforgettable moments with our professional event
                        management.</p>
                    <p class="text-[#b87f3a] font-semibold mt-3 group-hover:underline inline-flex items-center gap-2">
                        Learn More <i class="fa-solid fa-arrow-right text-xs"></i>
                    </p>
                ...
                <a href="{{ route('services.transport') }}"
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <div
                            class="w-12 h-12 bg-[#b87f3a]/10 rounded-full flex items-center justify-center group-hover:bg-[#b87f3a]/20 transition-colors">
                            <i class="fa-solid fa-car text-[#b87f3a] text-xl"></i>
                        </div>
                        <h3 class="font-display text-xl font-semibold text-[#1a1714]">Transport</h3>
                    </div>
                    <p class="text-[#7a7268] leading-relaxed">Reliable, comfortable, and affordable transport solutions for
                        all needs.</p>
                    <p class="text-[#b87f3a] font-semibold mt-3 group-hover:underline inline-flex items-center gap-2">
                        Learn More <i class="fa-solid fa-arrow-right text-xs"></i>
                    </p>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                <div>
                    ...
                    <h2 class="font-display text-3xl md:text-4xl font-semibold text-[#1a1714] mb-6">
                        Building Trust, <span class="text-[#b87f3a]">One Solution at a Time</span>
                    </h2>
                    <p class="text-[#7a7268] leading-relaxed mb-4">
                        Me For You Advisory was created with a vision to provide professional, reliable, and personalized
                        solutions that simplify everyday experiences.
                    </p>
                    <p class="text-[#7a7268] leading-relaxed mb-4">
                        From event management and housing solutions to transport services, we help individuals and
                        businesses navigate important moments with confidence, convenience, and peace of mind.
                    </p>
                    <p class="text-[#7a7268] leading-relaxed mb-6">
                        More than a service provider, we are a trusted partner committed to excellence, innovation, and
                        creating lasting value.
                    </p>
                    <a href="{{ route('contact') }}"
                        class="inline-flex items-center gap-2 bg-[#b87f3a] hover:bg-[#8a6e22] text-white font-semibold px-6 py-3 rounded-lg transition-colors">
                        <i class="fa-solid fa-phone"></i> Get in Touch
                    </a>
                </div>
                <div class="relative">
                    <div class="rounded-xl overflow-hidden shadow-lg">
                        <img src="{{ asset('assets/gallery/about-brand.webp') }}" alt="About ME FOR YOU"
    ...
    <section class="py-20 bg-[#b87f3a]">
        <div class="container mx-auto px-4 text-center text-white">
            ...
            <a href="{{ route('contact') }}"
                ...
                <i class="fa-solid fa-paper-plane"></i> Contact Us Today
            </a>
        </div>
    </section>
@endsection
